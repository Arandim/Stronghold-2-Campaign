This Campaign is divided into 4 chapters and is still being tested. If you find any bugs please write in the comments. In order to understand the missions you get please read the instructions for your current chapter, otherwise the progression will be very confusing. The Missions are meant to be played in the same order they are listed here.

# Chapter 1: Homecoming
## Mission A: Kill all the Bears
**Reward:**
...
## Mission B: Help to rebuild the monastery
**Reward:**
...
## Mission C: Destroy all the Bandit Hideouts
**Reward:**
...
**Win Conditions: No Enemies or Invasions are left**

# Chapter 2: Power Struggle
## Mission A: Acquire 80 Honor
**Reward:**
...
## Mission B: Acquire 150 Honor, 50 Beer, 200 Population
...
## Mission C: Acquire 250 Honor, Mission B must be completed
...
## Mission A: There are no rats or gong left in your estate
...
## Mission B: Prepare for the feast
